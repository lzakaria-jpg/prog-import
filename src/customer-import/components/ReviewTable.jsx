...
export default function ReviewTable({ eng, visibleKeys }) {
  ...
  return (
    <div className="qci-scroll" ref={vt.scrollRef}>
              ...
              <tr key={`${row.i}-${vt.startIndex + i}`} ref={i === 0 ? vt.measuredRowRef : undefined}
                ...
                <td>
                  {/* [إضافة 2026-09-21، طلب صريح من المستخدم: "يضغط على حذف ويتم
                      ...
                      قائمة الاستيراد، لا يُنشأ هذا العميل إطلاقاً. */}
                  <button type="button" className="qci-btn danger" style={{ padding: '4px 10px', fontSize: 12.5 }} title={t({ ar: 'حذف هذا الصف نهائياً', en: 'Delete this row permanently' })}
