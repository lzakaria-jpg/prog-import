...
describe('autoMap — أعمدة قالب Qoyod الرسمي الإنجليزية الحرفية (Import Customers)', () => {
  it('يربط كل عمود إلزامي/أساسي بحقله الصحيح عند رفع القالب نفسه', () => {
    const dataRows = [
      ['CUS1001', 'Ahmed Ali', 'Acme Trading', 'https://acme.com', '+966501234567', '+966507654321',
        'ahmed@acme.com', 'billing@acme.com', 'Active', '123 Ship St', 'Jeddah', 'Makkah', '54321', 'Saudi Arabia',
        '456 Bill St', 'Riyadh', 'Riyadh Province', '12345', 'Saudi Arabia', '312345678912343'],
      ['CUS1002', 'Sara Mohammed', 'Sara Est', 'https://sara.example', '+966512345678', '',
...
describe('autoMap — ملف عميل بأسماء أعمدة عربية حرة', () => {
  it('يربط الاسم والهاتف والبريد والرقم الضريبي من أسماء عربية شائعة', () => {
    const headers = ['اسم العميل', 'رقم الجوال', 'البريد الالكتروني', 'الرقم الضريبي', 'المدينة'];
    const dataRows = [
      ['محمد أحمد', '+966501112222', 'm@x.com', '312345678912343', 'الرياض'],
      ['فهد سالم', '+966503334444', 'f@x.com', '', 'جدة'],
    ];
