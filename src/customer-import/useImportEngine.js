...
export default function useImportEngine({ apiKey: apiKeyProp = '', onExport, onError } = {}) {
   ...
   * المعلَّقة) — طلب المستخدم "اعتماد كامل العملاء كعملاء جدد" حرفياً.
   */
  ...
  /** [إضافة 2026-09-21، طلب صريح من المستخدم] حذف صف بالكامل من قائمة الاستيراد — لا يُنشأ هذا العميل إطلاقاً */
