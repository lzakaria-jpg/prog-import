...
// [تصحيح 2026-09-17] الخطأ الحاجب الصريح لتاريخ استحقاق أسبق من الإصدار استُبدل
// بتطبيع تلقائي (raw ≥ d ⇒ لا تعديل، وإلا تعديل — راجع applyInvoiceImportMapping
// بـinvoiceImportMapping.js وengine/dates.js:normalizeDueDate) — لا خطأ حاجب
// من runValidation على E إطلاقًا بعد الآن لهذا السبب.
